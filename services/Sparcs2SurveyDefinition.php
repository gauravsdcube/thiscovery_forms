...
class Sparcs2SurveyDefinition
{
    ...
    public static function fields(): array
    {
        ...
        // Trailing break ends the A5 page. Its page_key/title apply to the NEXT
        // page (A6–A10), so they must stay in Section A — only the goto target
        // is Section D for bereavement / separation answers.
        $fields[] = self::pageBreak(
            'pb_a5_skip_bc',
            'section-a-continued',
